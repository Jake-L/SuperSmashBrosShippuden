...
namespace Super_Smash_Bros
{
    class Player : Sprite
    {
        ...
        int counterSprite;
        int counterSprite2;
        int counterSpriteModifier;
        int counterSpriteModRun;
        int counterSpriteAttack;
        int counterTaunt;
        int dx;
        int dy;
        int spriteRunLength;
        ...
        Rectangle finalDestinationRec = new Rectangle();
        ...
        public Player(Rectangle newRectangle, Texture2D newTexture, string newDirection, int newPlayer, string newCharacter, ContentManager cnt, int disWidth, int disHeight, Rectangle stage, int stageHeight, bool bot)
